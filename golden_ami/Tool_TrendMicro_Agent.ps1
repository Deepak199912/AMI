...
if ( $env:Install_MPS -eq 'true' ) {
    # Ref: https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-antivirus/microsoft-defender-antivirus-on-windows-server-2016#need-to-uninstall-microsoft-defender-antivirus
    Write-Output 'Disabling Defender as TrendMicro Agent is being installed'
    Uninstall-WindowsFeature Windows-Defender
    # Uninstall-WindowsFeature -Name Windows-Defender-GUI --> Doesn't work in Win 2019 also in 2016 this is disabled already by the above step

    Write-Output 'Install TrendMicro Agent'
    ...
    $WebClient.QueryString.Add("tenantID", "73416")
